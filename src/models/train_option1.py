"""
Train Models for Option 1: ZIP Code-Level Eviction Risk Prediction

This script trains models to predict high-risk ZIP codes (top 20% by eviction rate).
...
print("=" * 70)
print("Training Models for Option 1: ZIP Code-Level Prediction")
print("Predicting High-Risk ZIP Codes (Top 20% by Eviction Rate)")
print("=" * 70)

# Load ZIP-level dataset
print("\n1. Loading ZIP-level dataset...")
df = pd.read_csv(
...
exclude_cols = ['ZIP', 'Month', 'Year', 'High_Risk_ZIP', 'Eviction_Rate']
...
# Save results
results_path = "/Users/dtquynhanh/Documents/NYU/Predictive Analysis/FinalProject/dataset/models/option1_results.csv"
import os
